...
###############################################################################
# Visual Studio Code - Link para bajarlo
# https://code.visualstudio.com/Download

# Configuración del Poryecto
# Configure aqui directorio del Proyecto antes de compilar
PROJECTPATH = E:/MECA/2_Anio/2do_Cuatrimestre/Practicas_Compu_3/Ejercicios/MbedPcComunications
...
COMPILERDIR = E:/MECA/2_Anio/2do_Cuatrimestre/Practicas_Compu_3/util/compiladores/gcc-arm-none-eabi/bin
...
ASM_FLAGS += $(PROJECTPATH)/mbed_config.h
ASM_FLAGS += -c
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -Wall
